...
async def fetch_course_content_for_download(download_task: DownloadTask) -> Optional[Dict[str, Any]]:
...
def prepare_download_items(download_task: DownloadTask, course_data: Dict[str, Any]) -> list:
